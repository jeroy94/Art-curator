...
class Artist(db.Model):
    ...
    edition_adresse = db.Column(db.Boolean, default=False)
    edition_telephone = db.Column(db.Boolean, default=False)
    edition_email = db.Column(db.Boolean, default=False)
    edition_site = db.Column(db.Boolean, default=False)
    edition_facebook = db.Column(db.Boolean, default=False)
    nom_catalogue = db.Column(db.String(200), default='')
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
